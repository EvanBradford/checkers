...
namespace main_savitch_14
{
    ...
    virtual std::string get_user_move(const bool player)const;
	...
	// Have the next player make a specified move:
    	virtual void make_move(const std::string& move, const bool player) { ++move_number; }
		virtual void make_move_cpu(const std::string& move, const bool player) { ++move_number; }
	...
	// NOTE: positive values are good for the computer.
    	...
    	virtual bool is_game_over(bool fact)const = 0;
    	// Return true if the given move is legal for the next player:
    	virtual bool is_legal(const std::string& move, const bool player)const = 0;

		virtual bool move_available(const bool player) = 0;
	...
	void make_human_move(const bool player);
    };
}
#endif
